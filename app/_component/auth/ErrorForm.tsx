  ...
  return (
    <AuthBackground>
        ...
        <div className='flex justify-center items-center h-[60%]'>
            <div className='bg-black/80 rounded-xl p-6 w-[500px] space-y-5'>
                <h1 className='text-center text-xl'>Sorry Maybe Server Have Problem</h1>
                <div className='text-center'>
                  <BeatLoader color='white' />  
                </div>
                <button onClick={() => handleClick()} className='bg-red-600 w-full rounded-lg p-2 hover:bg-red-700 duration-300'>Back To Login</button>
            </div>
        </div>
        </div>
    </AuthBackground>
